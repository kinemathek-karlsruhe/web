...
return [
    ...
    'translations' => [
        ...
        'kinemathek.free'         => 'Freier Eintritt',
        ...
        'kinemathek.program.nonePast'  => 'Noch keine vergangenen Termine.',
        ...
        'kinemathek.mb.nav.all'          => 'Alle Bereiche',
        'kinemathek.mb.nav.program'      => 'Programm',
        'kinemathek.mb.nav.films'        => 'Filme',
        'kinemathek.mb.nav.events'       => 'Sonderveranstaltungen',
        ...
        'kinemathek.mb.showProgram'      => 'Spielplan anzeigen',
